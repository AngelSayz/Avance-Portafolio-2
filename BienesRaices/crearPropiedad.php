...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $query = "INSERT INTO propiedades (titulo, precio, imagen, descripcion, num_rooms, num_wc, num_garage, created, seller_id) VALUES ('$titulo', '$precio', '$imagen', '$descripcion', '$num_rooms', '$num_wc', '$num_garage', '$created', '$seller_id')";
